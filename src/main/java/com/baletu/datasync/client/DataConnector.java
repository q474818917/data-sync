...
public interface DataConnector {
     ...
     */
    void connect() throws DataClientException;
     ...
     * @throws DataClientException
     */
    void disconnect() throws DataClientException;
     ...
     * 
     * 说明：
     * a. 当前客户端一旦做为备份节点存在，当前所有的对{@linkplain DataConnector}的操作都会处于阻塞状态，直到转为工作节点
     * b. 所以业务方最好定时调用checkValid()方法用，比如调用CanalConnector所在线程的interrupt，直接退出CanalConnector，并根据自己的需要退出自己的资源
     * </pre>
     * 
     * @throws DataClientException
     */
    boolean checkValid() throws DataClientException;
     ...
     * @throws DataClientException
     */
    void subscribe(String filter) throws DataClientException;
     ...
     * @throws DataClientException
     */
    void subscribe() throws DataClientException;
     ...
     * @throws DataClientException
     */
    void unsubscribe() throws DataClientException;
     ...
     * @throws DataClientException
     */
    Message get(int batchSize) throws DataClientException;
     ...
     * @throws DataClientException
     */
    Message get(int batchSize, Long timeout, TimeUnit unit) throws DataClientException;
     ...
     * @throws DataClientException
     */
    Message getWithoutAck(int batchSize) throws DataClientException;
     ...
     * @throws DataClientException
     */
    Message getWithoutAck(int batchSize, Long timeout, TimeUnit unit) throws DataClientException;
     ...
     * @throws DataClientException
     */
    void ack(long batchId) throws DataClientException;
     ...
     * @throws DataClientException
     */
    void rollback(long batchId) throws DataClientException;
     ...
     * @throws DataClientException
     */
    void rollback() throws DataClientException;
}
